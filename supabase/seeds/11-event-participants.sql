...
VALUES
    ...
    -- James's parents
    (get_event_id('james_lily_marriage'), get_individual_id('fleamont_potter'), get_event_role_id('Father of Groom')),
    (get_event_id('james_lily_marriage'), get_individual_id('euphemia_potter'), get_event_role_id('Mother of Groom')),
    -- Lily's parents
    (get_event_id('james_lily_marriage'), get_individual_id('john_evans'), get_event_role_id('Father of Bride')),
    (get_event_id('james_lily_marriage'), get_individual_id('mary_evans'), get_event_role_id('Mother of Bride')),
    ...
    -- Harry's parents
    (get_event_id('harry_ginny_marriage'), get_individual_id('james_potter'), get_event_role_id('Father of Groom')),
    (get_event_id('harry_ginny_marriage'), get_individual_id('lily_evans'), get_event_role_id('Mother of Groom')),
    -- Ginny's parents
    (get_event_id('harry_ginny_marriage'), get_individual_id('arthur_weasley'), get_event_role_id('Father of Bride')),
    (get_event_id('harry_ginny_marriage'), get_individual_id('molly_prewett'), get_event_role_id('Mother of Bride')),
    ...
    -- Ron's parents
    (get_event_id('ron_hermione_marriage'), get_individual_id('arthur_weasley'), get_event_role_id('Father of Groom')),
    (get_event_id('ron_hermione_marriage'), get_individual_id('molly_prewett'), get_event_role_id('Mother of Groom')),
    -- Hermione's parents
    (get_event_id('ron_hermione_marriage'), get_individual_id('william_granger'), get_event_role_id('Father of Bride')),
    (get_event_id('ron_hermione_marriage'), get_individual_id('helen_granger'), get_event_role_id('Mother of Bride')),
