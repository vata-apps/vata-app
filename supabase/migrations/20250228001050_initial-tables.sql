...
CREATE UNIQUE INDEX individuals_gedcom_id_tree_key ON public.individuals USING btree (gedcom_id, tree_id);
...
-- Tree foreign key constraints
alter table "public"."families" add constraint "families_tree_id_fkey" FOREIGN KEY (tree_id) REFERENCES trees(id) ON UPDATE CASCADE ON DELETE CASCADE not valid;
alter table "public"."families" validate constraint "families_tree_id_fkey";

alter table "public"."family_children" add constraint "family_children_tree_id_fkey" FOREIGN KEY (tree_id) REFERENCES trees(id) ON UPDATE CASCADE ON DELETE CASCADE not valid;
alter table "public"."family_children" validate constraint "family_children_tree_id_fkey";

alter table "public"."individuals" add constraint "individuals_tree_id_fkey" FOREIGN KEY (tree_id) REFERENCES trees(id) ON UPDATE CASCADE ON DELETE CASCADE not valid;
alter table "public"."individuals" validate constraint "individuals_tree_id_fkey";

alter table "public"."names" add constraint "names_tree_id_fkey" FOREIGN KEY (tree_id) REFERENCES trees(id) ON UPDATE CASCADE ON DELETE CASCADE not valid;
alter table "public"."names" validate constraint "names_tree_id_fkey";

alter table "public"."places" add constraint "places_tree_id_fkey" FOREIGN KEY (tree_id) REFERENCES trees(id) ON UPDATE CASCADE ON DELETE CASCADE not valid;
alter table "public"."places" validate constraint "places_tree_id_fkey";

alter table "public"."place_types" add constraint "place_types_tree_id_fkey" FOREIGN KEY (tree_id) REFERENCES trees(id) ON UPDATE CASCADE ON DELETE CASCADE not valid;
alter table "public"."place_types" validate constraint "place_types_tree_id_fkey";

alter table "public"."event_types" add constraint "event_types_tree_id_fkey" FOREIGN KEY (tree_id) REFERENCES trees(id) ON UPDATE CASCADE ON DELETE CASCADE not valid;
alter table "public"."event_types" validate constraint "event_types_tree_id_fkey";

alter table "public"."event_roles" add constraint "event_roles_tree_id_fkey" FOREIGN KEY (tree_id) REFERENCES trees(id) ON UPDATE CASCADE ON DELETE CASCADE not valid;
alter table "public"."event_roles" validate constraint "event_roles_tree_id_fkey";

alter table "public"."events" add constraint "events_tree_id_fkey" FOREIGN KEY (tree_id) REFERENCES trees(id) ON UPDATE CASCADE ON DELETE CASCADE not valid;
alter table "public"."events" validate constraint "events_tree_id_fkey";

alter table "public"."event_subjects" add constraint "event_subjects_tree_id_fkey" FOREIGN KEY (tree_id) REFERENCES trees(id) ON UPDATE CASCADE ON DELETE CASCADE not valid;
alter table "public"."event_subjects" validate constraint "event_subjects_tree_id_fkey";

alter table "public"."event_participants" add constraint "event_participants_tree_id_fkey" FOREIGN KEY (tree_id) REFERENCES trees(id) ON UPDATE CASCADE ON DELETE CASCADE not valid;
alter table "public"."event_participants" validate constraint "event_participants_tree_id_fkey";
...
alter table "public"."individuals" add constraint "individuals_gedcom_id_tree_key" UNIQUE using index "individuals_gedcom_id_tree_key";
