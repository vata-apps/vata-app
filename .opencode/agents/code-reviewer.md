...
| -------------------------------------------------------------------------- | ------------------------------------------------------------- |
| `src/db/**`                                                                | `.opencode/skills/sqlite-standards/checklist.md`                |
| `src/lib/gedcom/**`, `src/managers/GedcomManager.ts`                       | `.opencode/skills/gedcom-standards/checklist.md`                |
| `src/**/*.{ts,tsx}` (excluding `src/db/**` and `src/lib/gedcom/**`)        | `.opencode/skills/typescript-standards/SKILL.md` (sections 1-6) |
| `src/components/**`, `src/pages/**`, `src/routes/**`, `src/styles/app.css` | `.opencode/skills/design-system-standards/SKILL.md`             |
| `src-tauri/**/*.rs`, `tauri.conf.json`                                     | `.opencode/skills/tauri-standards/SKILL.md`                     |
| `**/*.{test,spec}.{ts,tsx}`                                                | `.opencode/skills/testing-standards/SKILL.md`                   |
