...
- **Shared pitfalls live in CLAUDE.md**: the React.Fragment `key` rule, the `import.meta.env.DEV` debug-UI guard, and the no-unused-exports rule are in CLAUDE.md "Pitfalls" — not repeated here.
