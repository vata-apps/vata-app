...
- **Shell**: The in-tree shell (`TreeShell`) wraps every route under `/tree/$treeId/...` with a persistent navigation header above a full-width page body; pages own any panels they need (see [ADR-006](../adr/0006-full-width-shell.md)).
