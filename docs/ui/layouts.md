...
`TreeShell` (`src/components/tree-shell.tsx`) frames every route under `/tree/$treeId/...`. Full-width, pages-own-their-panels is a deliberate decision — see [ADR-011](../adr/0011-full-width-shell.md):
