...
> Parsing, formatting, validation, and all date logic are handled by the in-app module `@vata-apps/gedcom-date`. This document covers what matters for the Vata app: user input formats, storage, and display.
