...
const TREE_SCHEMA = `
  ...
  CREATE TABLE IF NOT EXISTS family_members (
    ...
    nature TEXT CHECK(nature IN ('biological', 'adoption', 'acknowledgment', 'marriage', 'common_law', 'step_parent', 'guardian')),
    certainty TEXT CHECK(certainty IN ('confirmed', 'probable', 'to_verify', 'disputed')),
    note TEXT,
