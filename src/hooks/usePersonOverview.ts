...
import { buildPersonOverview } from '$components/person-overview/build-overview';
 ...
 * tree data and maps it to the view-model in `select`, so the mapping re-runs
 * without refetching. Resolves to `null` when the individual is absent.
 */
